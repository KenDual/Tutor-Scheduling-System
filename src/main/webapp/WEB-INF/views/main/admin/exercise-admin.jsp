    ...
    <body class="g-sidenav-show  bg-gray-100">
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2"
            ...
            <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active bg-gradient-dark text-white" href="../pages/exercise-admin.html">
                ...
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Exercise-admin</li>
                        </ol>
                    </nav>
                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                                    <h6 class="text-white text-capitalize ps-3">Giảng viên: Lâm Chí Bảo</h6>
                                </div>
                            </div>
                            <div class="card-body px-0 pb-2">
                                <div class="table-responsive p-0">
                                    <table class="table align-items-center mb-0" id="exerciseTable">
                                        <thead>
                                            <tr>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tên bài tập</th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Chọn file
                                                </th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Set deadline
                                                    (ngày giờ)</th>
                                        ...
                                        <tbody id="exerciseTableBody">
                                            <tr>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="exerciseName1"
                                                           value="Bài tập toán chương 1" placeholder="Nhập tên bài tập">
                                                </td>
                                                <td>
                                ...
                                <button class="btn btn-success add-btn" onclick="addExerciseRow()">Thêm bài tập</button>
                                <div id="uploadedExercises" class="mt-3">
                                    <div class="alert alert-success" role="alert" id="exercise1">
                                        <strong>Upload thành công!</strong><br>
                                        Tên bài tập: Bài tập toán chương 1<br>
                                        File: Báo cáo 2006.docx<br>
                                        Deadline: 2025-06-03T01:45<br>
                                        <button class="btn btn-sm btn-danger" onclick="deleteExercise(1)">Delete</button>
                                        <button class="btn btn-sm btn-warning" onclick="editExercise(1)">Edit</button>
                                    </div>
                                    <div class="alert alert-success" role="alert" id="exercise2">
                                        <strong>Upload thành công!</strong><br>
                                        Tên bài tập: Tên bài tập 2<br>
                                        File: Final.docx<br>
                                        Deadline: 2025-06-19T04:48<br>
                                        <button class="btn btn-sm btn-danger" onclick="deleteExercise(2)">Delete</button>
                                        <button class="btn btn-sm btn-warning" onclick="editExercise(2)">Edit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script>
                            ...
                            function addExerciseRow() {
                                ...
                                newRow.innerHTML = `
              <td>
                <input type="text" class="form-control form-control-sm" id="exerciseName${exerciseCount}" placeholder="Nhập tên bài tập">
              </td>
              <td>
            ...
            `;
                            ...
                            function uploadExercise(rowId) {
                                ...
                                const exerciseInfo = `
              <div class="alert alert-success" role="alert" id="exercise${rowId}">
                <strong>Upload thành công!</strong><br>
                Tên bài tập: ${exerciseName}<br>
                File: ${fileName}<br>
                Deadline: ${deadline}<br>
                <button class="btn btn-sm btn-danger" onclick="deleteExercise(${rowId})">Delete</button>
                <button class="btn btn-sm btn-warning" onclick="editExercise(${rowId})">Edit</button>
              </div>
            `;
                            ...
                            function deleteExercise(rowId) {
                                const exerciseDiv = document.getElementById(`exercise${rowId}`);
                                if (exerciseDiv)
                                    exerciseDiv.remove();
                            }
