        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2"
            ...
            <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active bg-gradient-dark text-white" href="${pageContext.request.contextPath}/exercise-admin">
                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                                    <h6 class="text-white text-capitalize ps-3"><h6 class="text-white text-capitalize ps-3">Admin: ${adminName}</h6></h6>
                                </div>
                            </div>
                            ...
                            <div class="card-body px-0 pb-2">
                                        ...
                                        <tbody>
                                            <c:forEach var="exercise" items="${exercises}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="${pageContext.request.contextPath}/exercise-admin/edit/${exercise.exerciseId}" 
                                                           class="btn btn-sm btn-warning">Edit</a>
                                                        <a href="${pageContext.request.contextPath}/exercise-admin/delete/${exercise.exerciseId}" 
                                ...
                                <div class="text-end mt-3 me-3">
                                    <a href="${pageContext.request.contextPath}/exercise-admin/add" 
