...
<html lang="en">
    <head>
        ...
        <link id="pagestyle" href="<c:url value='/assets/css/material-dashboard.css?v=3.2.0'/>" />
    </head>
                ...
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">StudyMaterial-admin</li>
                        </ol>
                    </nav>
                            ...
                            <div class="card-body p-3 pb-0">
                                ...
                                <form id="uploadForm" enctype="multipart/form-data">
                                    <div class="input-group mb-3">
                                        <input type="file" class="form-control" id="fileInput" name="studyMaterial" accept=".pdf" multiple style="display: none;">
                                ...
                                <div id="uploadedFiles" class="mt-3">
                                    <div class="alert alert-success d-flex justify-content-between align-items-center mb-2">
                                        <span class="text-sm">Báo cáo cuộc họp.docx uploaded successfully</span>
                                        <div>
                                            <button class="btn btn-danger btn-sm" onclick="this.parentElement.parentElement.remove()">Delete</button>
                                            <button class="btn btn-warning btn-sm" onclick="editMaterial(this)">Edit</button>
                                        </div>
                                    </div>
                                    <div class="alert alert-success d-flex justify-content-between align-items-center mb-2">
                                        <span class="text-sm">Final.docx uploaded successfully</span>
                                        <div>
                                            <button class="btn btn-danger btn-sm" onclick="this.parentElement.parentElement.remove()">Delete</button>
                                            <button class="btn btn-warning btn-sm" onclick="editMaterial(this)">Edit</button>
                                        </div>
        ...
        <script>
                      ...
                      document.getElementById('fileInput').addEventListener('change', function () {
                          ...
                          for (let i = 0; i < files.length; i++) {
                              ...
                              fileDiv.className = 'alert alert-success d-flex justify-content-between align-items-center mb-2';
                              fileDiv.innerHTML = `
                <span class="text-sm">${fileName} uploaded successfully</span>
                <div>
                  <button class="btn btn-danger btn-sm" onclick="this.parentElement.parentElement.remove()">Delete</button>
                  <button class="btn btn-warning btn-sm" onclick="editMaterial(this)">Edit</button>
                </div>
              `;
                      ...
                      function editMaterial(button) {
                          ...
                          const fileNameSpan = fileDiv.querySelector('span');
                          alert(`Edit ${fileNameSpan.textContent}`);
                      }
        </script>
        <!-- Github buttons -->
