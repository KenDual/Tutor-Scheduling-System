            ...
            <div class="container-fluid py-2">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 mt-4 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <h6 class="mb-0 ">Sessions view</h6>
                                <p class="text-sm ">Last Session Performance</p>
                                <div class="pe-2">
                                    <div class="chart">
                    ...
                    <div class="col-lg-4 col-md-6 mt-4 mb-4">
                        <div class="card ">
                            <div class="card-body">
                                <h6 class="mb-0 "> Submitted Exercises </h6>
                                <p class="text-sm "> (<span class="font-weight-bolder">+15%</span>) increase in today exercises. </p>
                                <div class="pe-2">
                                    <div class="chart">
        ...
        <div class="fixed-plugin">
            ...
            <div class="card shadow-lg">
                ...
                <div class="card-body pt-sm-3 pt-0">
                    ...
                    <a class="btn bg-gradient-info w-100" href="https://github.com/KenDual/Tutor-Scheduling-System">Free
                        Download</a>
                    <a class="btn btn-outline-dark w-100"
                       href="https://github.com/KenDual/Tutor-Scheduling-System">View documentation</a>
                    <div class="w-100 text-center">
                        <a class="github-button" href="https://github.com/creativetimofficial/material-dashboard"
                           data-icon="octicon-star" data-size="large" data-show-count="true"
                           aria-label="Star creativetimofficial/material-dashboard on GitHub">Star</a>
                        <h6 class="mt-3">Thank you for sharing!</h6>
                        <a href="https://www.facebook.com/mai.phu.hai.2024/"
