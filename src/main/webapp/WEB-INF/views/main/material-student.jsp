                ...
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Study Material</li>
                        </ol>
                    </nav>
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <c:forEach var="material" items="${list}">
                                            <div class="alert alert-primary d-flex justify-content-between align-items-center text-white" role="alert">
                                                <div>
                                                    <span class="text-sm font-weight-bold">${material.title}</span>
                                                    <p class="text-xs mb-0">${material.description}</p>
